...
const Map<String, String> _kEn = {
  ...
  'Позже': 'Later',
  'Больше не предлагать эту версию': "Don't offer this version again",
  ...
  'Соединение потеряно — переподключаюсь…': 'Connection lost — reconnecting…',
  'нажми на сервер — переключусь без разрыва': 'tap a server — I will switch without dropping the VPN',
  'только что': 'just now',
  ...
  'Сам подключусь снова, если VPN оборвётся': 'Reconnects on its own if the VPN drops',
  ...
  'VPN всегда включён': 'Keep VPN always on',
  'VPN будет работать постоянно — даже после перезагрузки устройства': 'The VPN stays on permanently — even after the device reboots',
  'выключено — подключать вручную': 'off — connect manually',
  'Поднимется сам после перезагрузки телефона': 'Comes back by itself after the phone reboots',
  'Автозапуск с системой и мгновенное подключение': 'Launch with the system and connect instantly',
  'Always-on в настройках системы': 'Always-on in system settings',
  'Не удалось открыть настройки — найди раздел «VPN» в настройках телефона': "Couldn't open settings — find the «VPN» section in the phone settings",
  ...
  'движок туннеля неожиданно завершил работу': 'the tunnel engine quit unexpectedly',
